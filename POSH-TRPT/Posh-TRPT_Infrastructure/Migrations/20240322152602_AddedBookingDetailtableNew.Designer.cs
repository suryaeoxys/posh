...
namespace Posh_TRPT_Infrastructure.Migrations
{
    ...
    [Migration("20240322152602_AddedBookingDetailtableNew")]
    partial class AddedBookingDetailtableNew
    {
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "38528130-3979-4166-980a-6d7056af2531",
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            CreatedDate = new DateTime(2024, 3, 22, 20, 56, 2, 189, DateTimeKind.Local).AddTicks(1097),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHFigoL6nticCYzP/7xz/qqEIJ8i5MqD5/g11xWfxj2Lu/XgHOUIeOL5g1h+aUW3Mw==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "465e8d54-84a9-4cef-bfbd-41df192d9947",
                            StatusId = new Guid("57deeadb-b1c5-4273-a830-ed8d3b001f70"),
                            TwoFactorEnabled = false,
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            UpdatedDate = new DateTime(2024, 3, 22, 20, 56, 2, 189, DateTimeKind.Local).AddTicks(1111),
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.BookingDetail", b =>
                {
                    ...
                    b.HasOne("Posh_TRPT_Domain.Entity.ApplicationUser", "DriverUser")
                        .WithMany()
                        .HasForeignKey("DriverUserId");

                    b.HasOne("Posh_TRPT_Domain.Entity.ApplicationUser", "RiderUser")
                        .WithMany()
