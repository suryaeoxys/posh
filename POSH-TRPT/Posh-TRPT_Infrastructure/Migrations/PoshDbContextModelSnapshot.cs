...
namespace Posh_TRPT_Infrastructure.Migrations
{
    ...
    partial class PoshDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "515658e7-81e3-40b9-a9ec-9213d02a454f",
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            CreatedDate = new DateTime(2024, 5, 2, 8, 45, 49, 977, DateTimeKind.Local).AddTicks(4658),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKGIGbeEYSotqqYR3+I0vMlIhznPHFLjNMStEN4OykZaX62rJFKwRh8UiWc/4p4fJw==",
                            Payouts_Enabled = false,
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2398a114-bce1-4124-928e-631303b4db3c",
                            StatusId = new Guid("57deeadb-b1c5-4273-a830-ed8d3b001f70"),
                            TwoFactorEnabled = false,
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            UpdatedDate = new DateTime(2024, 5, 2, 8, 45, 49, 977, DateTimeKind.Local).AddTicks(4671),
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.BookingDetail", b =>
                {
                    ...
                    b.ToTable("TblBookingDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.BookingStatus", b =>
                {
                    ...
                    b.ToTable("TblBookingStatus", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.CategoryPrice", b =>
                {
                    ...
                    b.ToTable("TblCategoryPrices", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.MenuMaster", b =>
                {
                    ...
                    b.ToTable("TblMenuMaster", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.RideCategory", b =>
                {
                    ...
                    b.ToTable("TblRideCategory", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.StripeConnectAccountUsers", b =>
                {
                    ...
                    b.ToTable("TblStripeConnectAccountUsers", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.StripeCustomers", b =>
                {
                    ...
                    b.ToTable("TblStripeCustomers", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.StripeCustomersPaymentIntent", b =>
                {
                    ...
                    b.ToTable("TblStripeCustomersPaymentIntent", (string)null);
                });

            modelBuilder.Entity("Posh_TRPT_Domain.Entity.StripeCustomersSetupIntent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EphemeralKey_Secret")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("StripeCustomerRecordId");

                    b.HasIndex("UserId");

                    b.ToTable("TblStripeCustomersSetupIntent", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Register.Country", b =>
                {
                    ...
                    b.ToTable("Tbl_Countries", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Register.DriverDocuments", b =>
                {
                    ...
                    b.ToTable("TblDriverDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Register.GeneralAddress", b =>
                {
                    ...
                    b.ToTable("TblGeneralAddress", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Register.VehicleDetail", b =>
                {
                    ...
                    b.ToTable("TblVehicleDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Token.TokenInfoUser", b =>
                {
                    ...
                    b.ToTable("TblTokenInfoUsers", (string)null);
                });
            ...
            modelBuilder.Entity("Posh_TRPT_Domain.Entity.StripeCustomersSetupIntent", b =>
                {
                    b.HasOne("Posh_TRPT_Domain.Entity.StripeCustomers", "StripeCustomers")
                        .WithMany()
                        .HasForeignKey("StripeCustomerRecordId");
